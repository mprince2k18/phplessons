...
elseif(empty($_POST['cus_phone'])){
	$blank_cus_phone = 'give your phone number';
	header('location:index.php?cus_phone='.$blank_cus_phone);
}
...
<body>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo md5($_POST['cus_cnfrm_pass']) ?></td>
      <td><?php echo $_POST['cus_phone'] ?></td> 
